...
const sections = [
  {
    ...
    content:
      'A SkillIssue (a továbbiakban: „Szolgáltató") elkötelezett a felhasználók személyes adatainak védelme mellett. Ez a tájékoztató részletezi, hogy milyen adatokat gyűjtünk a rendszer működtetése során, és azokat hogyan használjuk fel.',
  },
  {
    number: "3",
  ...
  },
  {
    ...
    content:
      "A rendszer kizárólag a működéshez technikailag elengedhetetlen sütiket használ a Laravel Sanctum és munkamenet-kezelés révén. Marketing célú vagy harmadik féltől származó követő sütiket nem használunk.",
    bullets: [
  ...
  },
  {
    ...
    content:
      "Adatvédelmi kérdésekkel vagy az adatok törlésével kapcsolatban keress minket az alkalmazás hivatalos elérhetőségein.",
  },
];
  ...
  <div class="w-full min-h-[40vh] bg-bgDark flex flex-col items-center justify-center relative overflow-hidden pt-16">
    ...
    <div class="relative z-10 text-center px-4 py-20">
      ...
      <h1 class="text-5xl md:text-7xl font-bold text-white mb-4">
        Adatkezelési <span class="text-accentPurple">Tájékoztató</span>
      </h1>
    ...
    <Container>
      <div class="text-center mb-12">
        ...
        <p class="text-gray-500 mt-2">
          Az adatbázisunkban az alábbi adatcsoportokat tároljuk a szolgáltatás biztosítása érdekében.
        </p>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div
          ...
          :key="group.title"
          class="bg-white rounded-3xl shadow-md p-6 flex flex-col gap-4 hover:-translate-y-1 hover:shadow-xl transition-all duration-300"
        >
  ...
  <div class="bg-bgDark py-16 px-4 -mt-1">
    <Container>
      <div class="max-w-3xl mx-auto flex flex-col gap-6">
        ...
        >
          <div
            class="w-10 h-10 rounded-xl bg-accentPurple/10 border border-accentPurple/20 flex items-center justify-center shrink-0 mt-0.5"
          >
