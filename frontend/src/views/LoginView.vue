...
<template>
  <div class="bg-bgDark w-screen h-screen p-8">
    <div class="bg-bgAlternate w-full h-full rounded-md border border-white/25 grid grid-rows-1 grid-cols-2">
      <div class="items-center justify-center border-r border-white/25 relative">
        ...
        <div class="z-10 grid grid-cols-1 grid-rows-5 p-10 h-full">
          <div class="row-span-2 z-10 text-2xl md:text-5xl font-bold flex flex-col text-nowrap text-center gap-5 justify-center">
          ...
          <div class="row-span-3 grid grid-rows-3 grid-cols-3 gap-5 z-10 items-center text-center">
      ...
      <div class="grid grid-cols-1 grid-rows-5 p-10 h-full items-center justify-center">
        <div class="row-span-2 text-2xl md:text-5xl font-bold text-textWhite flex flex-col text-nowrap text-center gap-5 justify-center">Bejelentkezés</div>

        <form class="row-span-3 py-5 flex flex-col gap-3 items-center justify-start h-full">
          <Input name="email" autocomplete="email" placeholder="gipsz.jakab@gmail.com" icon="fa-solid fa-at" class="bg-accentGreen" />
          <Input name="password" autocomplete="password" type="password" placeholder="******" icon="fa-solid fa-key-skeleton" class="bg-accentGreen" />
