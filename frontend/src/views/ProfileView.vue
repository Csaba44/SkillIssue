  ...
  <ProtectedPageContainer class="relative overflow-hidden">
    ...
    <section v-if="profile" class="relative z-10 mt-20 max-w-6xl mx-auto px-4 text-textWhite">
      ...
      <div class="p-6 rounded-3xl bg-white/5 backdrop-blur-xl border border-white/10 shadow-xl mb-10">
        ...
        <div class="w-full h-5 bg-white/10 rounded-full overflow-hidden p-0.75">
          <div class="h-full rounded-full bg-linear-to-r from-accentYellow via-accentGreen to-emerald-400 transition-all duration-1000 ease-out shadow-[0_0_15px_rgba(234,179,8,0.2)]" :style="{ width: `${xpProgress}%` }"></div>
        </div>
        ...
        <div class="flex justify-between mt-3 text-xs text-textWhite/40 font-bold tracking-widest">
          ...
          <span v-if="profile.next_level" class="tracking-normal"> Még {{ profile.next_level.min_xp - profile.xp }} XP kell a szintlépéshez! </span>
      ...
      <div class="p-6 rounded-3xl bg-white/5 backdrop-blur-xl border border-white/10 shadow-2xl mb-10">
        ...
        <div v-else class="h-87.5 flex items-center justify-center text-white/20 border-2 border-dashed border-white/5 rounded-2xl text-center">
          <div>
      ...
      <div class="p-6 rounded-3xl bg-white/5 backdrop-blur-xl border border-white/10 shadow-2xl mb-10">
        ...
        <div v-else class="h-50 flex items-center justify-center text-white/20 border-2 border-dashed border-white/5 rounded-2xl text-center">Nincs elegendő adat az aktivitási térképhez.</div>
      </div>
    </section>
