...
<template>
  <div id="home" class="w-full min-h-screen bg-bgDark grid lg:grid-cols-2 lg:grid-rows-1 grid-cols-1 grid-rows-2 lg:items-center overflow-hidden">
    <Container class="mt-30 md:mt-0 h-full flex flex-col md:items-start items-center text-center md:text-left justify-center relative">
      <i class="fa-solid fa-graduation-cap text-[700px] text-accentPurple opacity-5 absolute top-30 left-15 rotate-20"></i>
      <h1 class="mt-10 md:mt-70 text-4xl lg:mt-0 xl:mt-0 md:text-6xl xl:text-8xl font-bold text-white text-nowrap">Érettségire fel!</h1>
      <h2 class="text-2xl sm:mt-5 md:text-xl lg:text-3xl mt-3 font-bold text-white w-full">Játssz, tanulj és készülj az érettségire!</h2>
