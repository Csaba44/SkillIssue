...
<template>
  <nav class="bg-bgDark text-white z-50 fixed w-screen">
    <Container>
      <div class="grid grid-rows-1 grid-cols-2 h-16 items-center">
        <div class="text-2xl md:text-3xl font-bold"><span>Skill</span><span class="text-primary">Issue</span></div>
