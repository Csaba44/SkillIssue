...
Az alkalmazáson belül előre létrehozott tesztfelhasználók is rendelkezésre állnak a különböző funkciók és jogosultságok kipróbálásához. Új fiók is regisztrálható, viszont az alábbi felhasználók is elérhetőek tesztelésre:

\begin{center}
    \begin{tabular}{lll}
     \textbf{Szerepkör} & \textbf{E-mail cím} & \textbf{Jelszó} \\
     \hline
     Adminisztrátor (Admin) & admin@gmail.com & password123 \\
     Általános felhasználó & gipsz.jakab@gmail.com & password123 \\
    \end{tabular}
\end{center}
